...
static const struct {
  ...
  char *profile;
    ...
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_HANDSET)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_SPEAKER, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_HANDSFREE)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_WIRED_HEADSET, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_HEADSET)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_WIRED_HEADPHONE, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_HEADPHONE)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_SPEAKER | AUDIO_DEVICE_OUT_WIRED_HEADPHONE, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_SPEAKERPHONE)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     0, PROFILE_NAME(VT_BT_NB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_BT_NREC_OFF, PROFILE_NAME(VT_BT_NREC_OFF_NB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_BT_STEREO, PROFILE_NAME(VT_STEREO_BT_NB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_BT_WB, PROFILE_NAME(VT_BT_WB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_BT_WB | PROFILE_BT_NREC_OFF, PROFILE_NAME(VT_BT_NREC_OFF_WB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_BT_WB | PROFILE_BT_STEREO, PROFILE_NAME(VT_STEREO_BT_WB)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     PROFILE_EXTRA_VOL, PROFILE_NAME(VT_HANDSET_EXTRAVOL_ON)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_SPEAKER, AUDIO_DEVICE_NONE,
     PROFILE_EXTRA_VOL, PROFILE_NAME(VT_HANDSFREE_EXTRAVOL_ON)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     PROFILE_DUAL_MIC, PROFILE_NAME(VT_HANDSET_DUALMIC)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     PROFILE_DUAL_MIC, PROFILE_NAME(VT_HEADSET_DUALMIC)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_SPEAKER, AUDIO_DEVICE_NONE,
     PROFILE_DUAL_MIC, PROFILE_NAME(VT_HANDSFREE_DUALMIC)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     PROFILE_LOOP, PROFILE_NAME(VT_HANDSET_LOOP)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_SPEAKER, AUDIO_DEVICE_NONE,
     PROFILE_LOOP, PROFILE_NAME(VT_HANDSFREE_LOOP)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_EARPIECE, AUDIO_DEVICE_NONE,
     PROFILE_LOOP, PROFILE_NAME(VT_HEADSET_LOOP)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_LOOP, PROFILE_NAME(VT_BT_NB_LOOP)},
    {AUDIO_MODE_CNT, AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, AUDIO_DEVICE_NONE,
     PROFILE_LOOP, PROFILE_NAME(VT_BT_WB_LOOP)},
};
...
//STR_ENUM_MAP_ITEM_PROFILE(VC_HEADSET_LOOP2)
//STR_ENUM_MAP_ITEM_PROFILE(VC_HEADSET_LOOP_ENH_OFF2)
